...
public class Client {
     ...
     */
    private void sendData(String message, int port, int requestType, String mode) {
        byte[] msg = sendingMsgFormation(message, requestType, mode);
     ...
     * @param requestType int request type 1 for read, 2 - write
     */
    public void run(int requestType, String message, String mode) {
        this.sendData(message, Host.HOST_PORT, requestType, mode);
        this.receiveMessage();
    }
    ...
    public static void main(String[] args) {
        ...
        String mode = "octEt"; // mode of the message
        ...
        for(int i = 0; i < max; i++) {
            if(i == max-1) {
                c.run(0, message, mode);
            } else {
                c.run((i % 2) + 1, message, mode);
            }
        }
    }
}
